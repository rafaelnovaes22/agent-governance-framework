---
product_code: "novais-fin"
product_name: "Novais Digital Fin"
...
linked_lifecycle: "products/novais-fin/lifecycle.md (a criar)"
owners:
...
version: "0.1.0"
production_url: "https://financeiro.novais-digital.com.br"
---

# Product Spec — Novais Digital Fin

> **Aplicação prática** do [`templates/product-spec.template.md`](../../../templates/product-spec.template.md).
> Novais Digital Fin está atualmente em **Beta** em produção em `https://financeiro.novais-digital.com.br`.
...
```
Novais Digital Fin entrega análise financeira mensal estruturada (DRE + leitura
...
```
Novais Digital Fin entrega análises mensais baseadas nos lançamentos importados pelo
cliente. Limites:
...
- Localização: `evals/novais-fin/cases/` (no repo do produto, não no `novais-digital-governanca-ia`)
...
- [x] Código rodando em produção (`https://financeiro.novais-digital.com.br`)
...
| LLM | Anthropic (Claude Sonnet 4.6 + Opus para análise complexa) | Escolha Foundry default |
