# Novais Digital — Portfolio em 3 categorias

> Aplicação prática do princípio C11 (extensão Novais Digital) — portfolio multi-categoria.
> Origem da decisão: ADR-002 do projeto `novais-digital-governanca-ia`.

---

## Visão geral

A Novais Digital opera **3 categorias formais de oferta**, complementares e não-concorrentes:
...
```
              ...
              ↓                                 ↓
   ┌──────────────────┐              ┌──────────────────┐
   │ Novais Digital Plataforma│              │ Novais Digital Produtos  │
...
## Categoria 1 — Novais Digital Diagnóstico
...
## Categoria 2 — Novais Digital Plataforma (high-touch SaaS²)

| Atributo | Valor |
|---|---|
| **ICP** | PME R$ 2M+ pós-Diagnóstico, com volume mensal ≥ 50–100 outcomes/processo |
| **Cliente loga?** | ❌ Não — entrega async (WhatsApp, email, webhook); ClickUp é interno Novais Digital |
...
## Categoria 3 — Novais Digital Produtos (self-serve SaaS²)
...
|---|---|---|---|---|
| **Novais Digital Fin** | **Beta** | Lovable + Supabase | Análise financeira mensal + plano de ação | `https://financeiro.novais-digital.com.br` |
| **Novais Digital Educacional** | **Discovery** | TBD | TBD | — |

Detalhe em [`products/novais-fin.md`](./products/novais-fin.md) e [`products/novais-educacional.md`](./products/novais-educacional.md).
...
- Cliente Plataforma SKU `triagem-comercial` pode comprar Produto `Novais Digital Fin` como complemento
