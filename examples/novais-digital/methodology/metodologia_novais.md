# Metodologia Novais Digital — Service-as-a-Software para PMEs em modo bombeiro
...
Isso muda tudo na metodologia da Novais Digital. Três implicações práticas:

1. **O modelo econômico clássico (pay-per-seat) está colapsando** — em 2026 o mercado já documentou um corte de aproximadamente **US$ 285 bilhões em valuations de SaaS tradicional** ("SaaSpocalypse"), exatamente porque clientes estão reduzindo licenças à medida que agentes de IA substituem trabalho humano. A Novais Digital está nascendo no lado vencedor dessa transição — desde que execute o modelo certo.
...
A referência canônica do modelo é o que Sierra, Zendesk e Salesforce já operam: Zendesk cobra **US$ 1,50 por ticket resolvido autonomamente** (definido por janela silenciosa de 72h sem reabertura); Salesforce Agentforce cobra **US$ 2 por conversa agêntica resolvida**. A Novais Digital precisa ter sua própria unidade de outcome — escolher essa unidade é a decisão estratégica mais importante do ano.

---

## O framework Novais Digital SaaS² — cinco fases
...
Esta fase não é por cliente — é **por categoria de processo**. É o que separa Novais Digital-consultoria-disfarçada de Novais-SaaS²-real. A pergunta certa não é *"como atendo o próximo cliente?"*, é *"qual o terceiro cliente do mesmo processo que custa 10% do esforço do primeiro?"*.
...
## A unidade fundamental: definir o "outcome cobrável" da Novais Digital
...
Para o ICP da Novais Digital (operação caótica em PME R$2M+), os mais promissores são: **leads qualificados, tickets/conversas resolvidos, e tarefas de back-office completadas**. São processos com volume suficiente, baseline de custo claro (CEO sabe quanto paga em SDR ou atendente), e outcome inequívoco.
...
- **Estrutura comercial**: setup fee curto (paga o onboarding) + mensalidade fixa baixa (paga a plataforma) + variável por outcome (onde está a margem). Isso é o que faz a Novais Digital escalar **como produto**, e não como agência.
...
Considerando o portfólio técnico existente (Node/TS, LangGraph, PostgreSQL, BullMQ, WhatsApp Cloud API — basicamente o stack do CarInsight), a infraestrutura SaaS² da Novais Digital pode reaproveitar massivamente:
...
## Riscos específicos de SaaS² para o estágio atual da Novais Digital
...
**Mês 1.** Documentar o processo automatizado em cada cliente atual. Identificar qual deles pode virar o primeiro SKU empacotado da Novais Digital. Definir a unidade de outcome cobrável e fazer o exercício de unit economics por SKU.
...
> A Novais Digital é uma empresa de **agentes de IA empacotados como SKUs verticais** para processos repetitivos de PMEs caóticas, **cobrando por outcome entregue** com plataforma fixa, **vendendo paz para CEOs bombeiros**, e escalando por catálogo — não por hora consultiva.
