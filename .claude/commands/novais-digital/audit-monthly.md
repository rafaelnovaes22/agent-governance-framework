...
5. **C6 audit — WireLog** (`analytics_provider`, quando declarado) — desvio DB outcomes ↔ `foundry_outcome_delivered` ≤ 5%? PII crua em eventos? Queries de funil: `foundry_outcome_created → delivered → billed`.
