...
9. Emitir eventos WireLog (se project.telemetry.analytics_provider=wirelog):
   - foundry_eval_started: no início (passo 1) com artifact_id, lifecycle_stage, run_id
   - foundry_eval_completed: após agregar métricas com pass_rate, status, trace_id, latency_ms
