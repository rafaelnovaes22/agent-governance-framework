...
- `spec`: "Edite `docs/specs/{module}.md` e execute `/acme:aios-run --module {module} --step spec` novamente"
...
Aguarde "Kernel online" no log antes de executar /acme:aios-run.
...
timestamp_end: <>
trace_id: <>
next_step: "/acme:aios-run --module {module} --step test"  # se gate_failed
```
...
| Versão | Data | Mudança |
|---|---|---|
| 0.1.0 | 2026-05-06 | Versão inicial — Forge-6 AIOS run com gates C4 |
