...
> Em projetos multi-tenant, o "organização" é a entidade-mãe (provedora do serviço), não o tenant final. DNA por tenant é Tier 2 — use `tenant-context-loader` (Foundry-1, escopo Novais-específico).
